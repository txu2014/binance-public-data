...
import pandas as pd
from enums import *
from utility import delete_file, get_all_symbols, get_parser, get_start_end_date_objects, convert_to_date_object, \
    get_path
        ...
        for year in years:
            for month in months:
                ...
                if current_date >= start_date and current_date <= end_date:
                    ...
                    delete_file(path, file_name, date_range, folder)
...
if __name__ == "__main__":
    ...
    if args.dates:
        ...
        # download_monthly_trades(args.type, symbols, num_symbols, args.years, args.months, args.startDate, args.endDate,
